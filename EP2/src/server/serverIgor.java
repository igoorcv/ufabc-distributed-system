...
import server.serverIgor.ClientHandler;

public class serverIgor {
    private static Map<String, Item> key_value_store = new HashMap<>();  // Dicionário para armazenar os pares chave-valor
    ...
    public serverIgor(String server_IP, int server_Port) throws IOException {
        this.server_IP = server_IP;
        this.server_Port = server_Port;
        this.isMaster = this.server_IP.equals(this.LEADER_IP) && this.server_Port == this.LEADER_PORT;
        this.serverSocket = new ServerSocket(this.server_Port, 50, InetAddress.getByName(this.server_IP));
